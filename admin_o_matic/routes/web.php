...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum', 'verified', 'role:super_admin|admin|user'])->group(function() {
    ...
    Route::resource('technician', TechnicianController::class)->except(['create', 'show', 'edit']);
